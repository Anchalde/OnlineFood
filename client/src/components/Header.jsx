        ...
        <div className="flex items-center h-full justify-between">
          ...
          <Link to={""}>
            <div className="h-12 flex items-center md:text-lg font-bold font-sans">
              <h1 className="text-xl">Online<span className="text-white bg-slate-800 ml-1 py-.1 px-1">Food</span></h1>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-4 md:gap-7">
            <nav className=" gap-4 md:gap-6 text-base md:text-lg hidden md:flex">
              ...
              <Link to={"menu/64380e5a3117eade68edec02"} className="hover:text-slate-700">Menu</Link>
              ...
              {showMenu && (
                <div className="absolute right-2 bg-white py-2 px-2 shadow drop-shadow-md text-base flex flex-col min-w-[120px] text-center">
                  ...
                  <nav className="text-base md:text-lg flex flex-col md:hidden">
                    ...
                    <Link to={"menu/64380e5a3117eade68edec02"} className="hover:text-slate-700 px-2 py-2">Menu</Link>
